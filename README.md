# Available .LIVE One-Word Domains (10,359)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-10%2C359%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **10,359 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 10,359 domains · **Median ask:** $39.13 · **High-demand under $2,500:** 2
...
| result.live    | resell    | —         | —             | high           | low    | 6      | DNSPod, Inc.                                 |
| leg.live       | premium   | $140      | $280          | high           | low    | 3      | namecheap                                    |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 10,359 live domains                        |
...
> Unique Domains. *Available .LIVE One-Word Domains*. Version 2026-08-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
