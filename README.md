# Available .LIVE One-Word Domains (9,099)
...
> The full live catalog for this exact search currently contains **9,099 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,099 domains · **Median ask:** $47.76 · **High-demand under $2,500:** 1
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,099 live domains                         |
...
> Unique Domains. *Available .LIVE One-Word Domains*. Version 2026-08-06. Public GitHub extract for the exact Unique Domains search represented by this repository.
